...
public class GuiAdvancedElectricFurnace extends GuiContainerGC {
    
    private static final ResourceLocation electricFurnaceTexture;
    private GuiElementInfoRegion electricInfoRegion = new GuiElementInfoRegion(0, 0, 56, 9, (List)null, 0, 0, this);
    private TileAdvancedElectricFurnace tileEntity;
    
    public GuiAdvancedElectricFurnace(InventoryPlayer par1InventoryPlayer, TileAdvancedElectricFurnace tileEntity) {
        super(new ContainerAdvElectricFurnace(par1InventoryPlayer, tileEntity));
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (this.tileEntity.processTicks > 0) {
            scale = (int)((double)this.tileEntity.processTicks / (double)this.tileEntity.processTimeRequired * 23.0D);
    ...
    static {
        electricFurnaceTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/electric_furnace.png");
    }
}
