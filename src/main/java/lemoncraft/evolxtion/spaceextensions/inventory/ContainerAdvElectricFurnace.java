package lemoncraft.evolxtion.spaceextensions.inventory;
...
public class ContainerAdvElectricFurnace extends Container {
    private TileAdvancedElectricFurnace tileEntity;
    
    public ContainerAdvElectricFurnace(InventoryPlayer par1InventoryPlayer, TileAdvancedElectricFurnace tileEntity) {
        this.tileEntity = tileEntity;
        this.addSlotToContainer(new SlotSpecific(tileEntity, 0, 8, 49, new Class[]{IItemElectric.class}));
